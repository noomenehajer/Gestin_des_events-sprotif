...
//php artisan make:controller EvennementSportifController --model EvennementSportif
...
class EvennementSportifController extends Controller
{
    ...
    {
        return view('events.details-event',  [
            'title' => 'Evennement sportif: ' . $eventSportif->nom,
